...
module.exports = Loader = React.createClass({displayName: 'Loader',
  render: function(){
    return (
      React.DOM.div({className: "loader" + (this.props.paging ? " active" : "") + (this.props.top ? " top" : "") + " col-sm-12"}, 
...
module.exports = NotificationBar = React.createClass({displayName: 'NotificationBar',
	...
	render: function(){
		...
		return (React.DOM.div({className: "notification-bar" + (count ? ' active' : '')}, 
					React.DOM.span(null, "There are ", count, " new tickets! ", React.DOM.a({href: "#top", onClick: this.showNewTickets}, "Click here to see them."))
				));
	}
});
...
module.exports = ZendeskApp = React.createClass({displayName: 'ZendeskApp',
	...
	render: function()
	{
		return (React.DOM.div({className: "zendesk-app"}, 
